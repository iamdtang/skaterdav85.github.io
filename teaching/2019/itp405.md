...
<!-- ### (3/19) Week 11 - Node.js 2: Sequelize ORM

* CommonJS Modules
* [Sequelize ORM](http://docs.sequelizejs.com/)
* [Postman](https://www.getpostman.com/downloads/)
* [Lab 5 - Build an API Endpoint with Express and Sequelize](/teaching/2019/labs/sequelize-orm) -->

### (3/12) Week 10 - Spring Break

* No class

### (3/5) Week 9 - Node.js 3: Real-Time with Web Sockets

* [ws: a Node.js WebSocket library](https://www.npmjs.com/package/ws)
* [Lecture Recording](http://www.youtube.com/watch?v=dQTzL3enFng)
* [Lab 4 - An Editable Document](/teaching/2019/labs/web-sockets)
