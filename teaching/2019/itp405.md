...
### (2/19) Week 7 - Node.js 1: The Fundamentals and Building an API

* [Node.js](https://nodejs.org/en/)
* [Node Version Manager (nvm)](https://github.com/creationix/nvm)
* JavaScript Fundamentals
  * Defining functions
  * Asynchronous Patterns: Callbacks and Promises
...
* Deploying to Heroku
* [Lab 3 - Building API Endpoints with Express](/teaching/2019/labs/node-1)
