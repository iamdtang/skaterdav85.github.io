...
1. [Example 1: Counter with a class](https://codesandbox.io/s/sad-edison-enfs5?fontsize=14)
1. [Example 2: Counter with a hook](https://codesandbox.io/s/snowy-cache-7lgd7?fontsize=14)
1. [Example 3: Fetching data with `useEffect`](https://codesandbox.io/s/fetch-data-with-useeffect-e3efp?fontsize=14)
...
1. [Example 4: Fetching data with `useEffect`](https://codesandbox.io/s/useeffect-03dff)
