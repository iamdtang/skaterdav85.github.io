...
1. [Ember Octaine Guides](https://octane-guides-preview.emberjs.com/release/)
1. [Ember CLI Mirage](https://www.ember-cli-mirage.com/)
1. [QUnit DOM Assertions](https://github.com/simplabs/qunit-dom/blob/master/API.md)
