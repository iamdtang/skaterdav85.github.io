...
### (11/12) Week 12 - Environment Variables in React / Testing Components with Network Requests
...
1. [Fetch data with `useEffect`](https://codesandbox.io/s/fetch-data-with-useeffect-e3efp?fontsize=14)
