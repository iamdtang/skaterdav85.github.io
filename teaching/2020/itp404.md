...
### (10/6) Week 8 - JSON Server (Part 2 - DELETE/POST/PUT), Portals

- More JSON Server (relationships, query params and sorting, deploying)
- [Demo (see `class-2` branch or Pull Requests 6-*)](https://github.com/ITP-404-Fall-2020-Demos/week6
