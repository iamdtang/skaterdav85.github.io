...
### (8/18) Week 1 - Ajax and Client-side Rendering

- Course introduction
- Traditional web applications vs. single page applications (SPAs)
- [Ajax](https://docs.google.com/presentation/d/1r-3XtJXG_Y9_grUYhEidIaCz0SOYWcAKugGrGrrc8Lo/edit?usp=sharing)
- [HTTP response status codes](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status)
- [DOMPurify](https://github.com/cure53/DOMPurify)
- JSON, JavaScript objects, and traversing JSON
