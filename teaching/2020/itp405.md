...
* Common JS modules
  * [See 2.1 pull request](https://github.com/ITP-405-Spring-2020-Demos/express-api)
* How to use promises
  * then, catch
  * returning promises within then
* Creating Promises
  * The Promise constructor
  * Exercise: Promisify `setTimeout`
  * Promisifying last week's routes
...
* [Building an API with Express (see 2.x pull requests)](https://github.com/ITP-405-Spring-2020-Demos/express-api)
* [How promises work](https://promisesaplus.com/)
* [Knex.js](https://knexjs.org/) examples
* [Promises](https://scotch.io/tutorials/javascript-promises-for-dummies)
* Deploying a Node API to Heroku
* Assignment 6 - Building an API with Express and Knex -->
