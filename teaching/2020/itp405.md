...
### (4/13) ORM with Sequelize or TypeORM?

* Assignment 8 - Building an API with Sequelize
* Lab 5 - Research Relational vs. Non-relational Databases

### (4/6) Real-Time with WebSockets

* Assignment 7 - Editable Document

### (3/30) Week 12 - Building an API in Node.js

* Assignment 6 - Building an API with Express

### (3/23) Week 11 - Laravel Wrap-up / Introduction to Node.js

* [Midterm Review](https://github.com/skaterdav85/itp405-midterm)
...
* Modules and [npm](https://www.npmjs.com/)
...
* Asynchronous Programming Patterns
  ...
  * `async/await`
* [A Journey into Node.js Internals (Advanced)](https://www.youtube.com/watch?v=LbwUETu7Rgc)
